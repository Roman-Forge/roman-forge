...
const navigation = {
  ...
  social: [
    ...
    {
      name: "Facebook",
      href: "https://facebook.com/profile.php?id=61575806189799",
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
  ...
  return (
    <>
      <section className="text-center py-10 bg-orange-100">
        <h2 className="font-bold text-3xl mb-4 text-deepteal">
          Ready to Forge Your Digital Future?
        </h2>
        <p className="font-garamond text-lg mb-6">
          Contact us today to discuss how Roman Forge can elevate your online
          presence with our comprehensive web services!
        </p>
        <Link
          to="/contact"
      ...
      <footer className="bg-deepblue relative overflow-hidden bg-[url('./roman-footer-circle.png')] bg-[length:100%] bg-no-repeat bg-[-32em 6%]">
        <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
          ...
          <p className="mt-10 text-center text-sm/6 text-gray-400">
            &copy; {currentYear} Roman Forge, Inc. All rights reserved.
          </p>
        </div>
      </footer>
    </>
