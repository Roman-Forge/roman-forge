  ...
  const services = [
    {
      ...
      description:
        "Transform your vision into stunning, responsive websites tailored to your business needs with cutting-edge design and development.",
      icon: "PaintBrushIcon",
    },
    {
      name: "Web Development",
      description:
        "Build fast, scalable, and modern websites using advanced technologies like React, Node.js, and more to power your online presence.",
      icon: "CodeBracketIcon",
    },
    {
      name: "E-Commerce Solutions",
      description:
        "Launch a powerful online store with secure payment gateways, product management, and custom designs to boost your sales.",
      icon: "ShoppingCartIcon",
    },
    {
      name: "SEO & Optimization",
      description:
        "Skyrocket your search engine rankings and attract more customers with expert SEO and performance optimization services.",
      icon: "MagnifyingGlassIcon",
    },
    {
      name: "Content Management",
      description:
        "Take control of your website with intuitive CMS solutions, including content creation, logos, and social media graphics.",
      icon: "DocumentTextIcon",
    },
    {
      name: "Branding & Creative Services",
      description:
        "Stand out with professional branding, logo design, and creative content to elevate your brand identity.",
      icon: "SparklesIcon",
    },
    {
      name: "Ongoing Maintenance",
      description:
        "Ensure your site runs smoothly with 24/7 support, updates, and security monitoring tailored to your needs.",
      icon: "WrenchScrewdriverIcon",
    },
    {
      name: "Performance Boost",
      description:
        "Enhance user experience and SEO with lightning-fast load times and comprehensive performance tuning.",
      icon: "BoltIcon",
    },
    {
      name: "Hosting & Deployment",
      description:
        "Reliable, secure hosting and seamless deployment with top-tier platforms to keep your site online and accessible.",
      icon: "CloudIcon",
    },
  ];
    ...
    <>
      <section className="flex container mx-auto py-8">
        <div className="w-1/2 mr-auto flex flex-col justify-center">
          ...
          <p className="font-garamond text-3xl">
            The ultimate web development agency for all your digital needs –
            from stunning websites to e-commerce, SEO, and beyond. We’re your
            jack-of-all-trades web shop!
          </p>
        </div>
        <div className="full lg:w-1/3 flex justify-center items-center">
          <img
            className="h-[80%]"
            src="/roman-forge-r.png"
            alt="Roman Forge High-Tech Header Image"
          />
        </div>
      </section>
      <section className="container mx-auto mb-32 py-6 bg-sand flex justify-center">
        ...
        <div className="translate-y-16 w-1/3 pl-10">
          ...
          <h3 className="font-garamond text-5xl mb-6">
            Meet Roman Forge – Your Digital Architects
          </h3>
          <p className="font-garamond text-md mb-10">
            Led by Jacob Roman, a seasoned Senior Digital Engineer with over 8
            years of experience, Roman Forge blends innovation with expertise to
            deliver top-tier web solutions. From startups to established
            businesses, we’ve got you covered!
          </p>
          <h4 className="font-garamond text-3xl text-orange-900 font-semibold">
            Partner with us to forge a digital future that lasts!
          </h4>
        </div>
      </section>
      <section className="container mx-auto mb-20">
        ...
        <ul className="grid grid-cols-3 gap-4">
          {services.map((service) => (
            <li
              key={service.name}
              className="bg-gray-100 group rounded p-5 border duration-300 ease-in-out overflow-hidden relative"
            >
              <div className="p-4 mb-8 bg-white rounded transform transition animate-fade-in inline-grid group-hover:opacity-10 group-hover:scale-[960%] group-hover:translate-x-48 relative group-hover:bg-deepteal">
                {React.createElement(
                  ...
                  {
                    className:
                      "w-6 h-6 group-hover:rotate-6 group-hover:scale-[100%] group-hover:stroke-white",
                  },
                )}
              </div>
              <h3 className="text-2xl group-hover:z-10 group-hover:relative">
                {service.name}
              </h3>
              <h4 className="group-hover:z-10 group-hover:relative">
                {service.description}
              </h4>
            </li>
          ))}
      ...
      <section className="bg-deepteal">
        <div className="container mx-auto flex flex-row">
          <div className="flex justify-center flex-col">
            ...
            <h3 className="text-white font-lexend text-6xl font-semibold mb-8">
              Cutting-Edge Tools for Your Success
            </h3>
            <p className="text-sand font-garamond text-2xl font-semibold">
              Leverage the power of React, Node.js, GraphQL, and more to create
